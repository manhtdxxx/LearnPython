...
# np.arange(start,stop,step) : Array RANGE tạo mảng 1 chièu
b = np.arange(10)
print('ARRAY RANGE:',b)
...
# np.linspace(start,stop,size) : linear space để tạo mảng 1 chiều
...
# np.random.rand(rows,columns) : tương tự random nhưng trong () không cần ()
x = np.random.rand(4,5)
print(x)
print()

# np.random.random(start, stop, size) : generate random int numbers from a to b
...
### TẠO SEED
# object: random_number_generator
